...
from {{cookiecutter.app_name}}.middleware.rate_limit import RateLimiter, rate_limit_middleware
...
class TestRateLimiter:
    ...
    @pytest.mark.asyncio
    @patch('{{cookiecutter.app_name}}.middleware.rate_limit.redis_client')
