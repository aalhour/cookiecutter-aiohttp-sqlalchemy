"""
Database initialization script for populating the database with sample data.

This script demonstrates how to:
- Initialize the database connection
- Create sample records using the async ORM
- Can be run via: python -m {{cookiecutter.app_name}}.scripts.init_db
"""
import asyncio
from decimal import Decimal

from {{cookiecutter.app_name}}.core.database import db, transactional_session
...
async def async_init_db() -> None:
    """Async initialization of database with sample data."""
    _logger.info("init_db_start")
...
def init_db() -> None:
    """Entry point for the init_db console script."""
