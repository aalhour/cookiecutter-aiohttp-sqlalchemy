...
from {{cookiecutter.app_name}}.core.database import transactional_session
...
from {{cookiecutter.app_name}}.schemas.example import ExampleCreate, ExampleResponse, ExampleUpdate
