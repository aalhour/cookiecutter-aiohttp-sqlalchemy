...
class DatabaseSettings(BaseSettings):
    ...
    port: int = {{cookiecutter.db_port}}
    user: str = "{{cookiecutter.db_user}}"
    password: str = ""
    name: str = "{{cookiecutter.db_name}}"
    schema_: str = Field(default="{{cookiecutter.db_schema}}", alias="schema")
...
class TelemetrySettings(BaseSettings):
    ...
    enabled: bool = False
    service_name: str = "{{cookiecutter.app_name}}"
    otlp_endpoint: str = ""
