...
class TestHttpGetAllUnitTestCase:
    ...
    @patch('example_web_app.models.example.Example.get_all', new_callable=AsyncMock)
...
class TestHttpGetByIdUnitTestCase:
    ...
    @patch('example_web_app.models.example.Example.get_by_id', new_callable=AsyncMock)
    @patch('example_web_app.controllers.example_api.transactional_session')
...
class TestHttpCreateUnitTestCase:
    ...
    @patch('example_web_app.models.example.Example.create', new_callable=AsyncMock)
    @patch('example_web_app.controllers.example_api.transactional_session')
...
class TestHttpDeleteUnitTestCase:
    ...
    @patch('example_web_app.models.example.Example.delete_by_id', new_callable=AsyncMock)
    @patch('example_web_app.controllers.example_api.transactional_session')
